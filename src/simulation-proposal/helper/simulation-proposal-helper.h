...
#ifndef SIMULATION_PROPOSAL_HELPER_H
#define SIMULATION_PROPOSAL_HELPER_H
 ...
 * on a set of nodes.
 */
class SimulationProposalHelper
{
public:
  /**
   ...
   *        to.
   */
  SimulationProposalHelper (std::string protocol, Address address);
