...
#ifndef SIMULATION_PROPOSAL_HELPER2_H
#define SIMULATION_PROPOSAL_HELPER2_H
 ...
 * on a set of nodes.
 */
class SimulationProposalHelper2
{
public:
  /**
   ...
   *        to.
   */
  SimulationProposalHelper2 (std::string protocol, Address address);
...
#endif /* SIMULATION_PROPOSAL_HELPER_H */
